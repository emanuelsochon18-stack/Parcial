...
const componentes = [
...

    {
        ...
        simbolo: "../segundo nivel/img/simbologia/eramico.png",
...
function crearPregunta() {
    ...
    let respuestas = [
        ...
        componenteCorrecto.funcion

    ];


    // Obtener funciones incorrectas

    let incorrectas = componentes
        .filter(componente =>
